...
(cl:defmethod cl:initialize-instance :after ((m <Float64Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_webots-msg:<Float64Stamped> is deprecated: use comm_webots-msg:Float64Stamped instead.")))
...
(cl:defmethod data-val ((m <Float64Stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_webots-msg:data-val is deprecated.  Use comm_webots-msg:data instead.")
  (data m))
