...
(cl:defmethod cl:initialize-instance :after ((m <Int8Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Int8Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_webots-msg:<Int8Stamped> is deprecated: use comm_webots-msg:Int8Stamped instead.")))
