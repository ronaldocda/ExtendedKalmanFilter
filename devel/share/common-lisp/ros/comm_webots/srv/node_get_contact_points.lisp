...
(cl:defmethod cl:initialize-instance :after ((m <node_get_contact_points-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_contact_points-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_webots-srv:<node_get_contact_points-request> is deprecated: use comm_webots-srv:node_get_contact_points-request instead.")))

(cl:ensure-generic-function 'node-val :lambda-list '(m))
(cl:defmethod node-val ((m <node_get_contact_points-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_webots-srv:node-val is deprecated.  Use comm_webots-srv:node instead.")
  (node m))
...
(cl:defmethod include_descendants-val ((m <node_get_contact_points-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_webots-srv:include_descendants-val is deprecated.  Use comm_webots-srv:include_descendants instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<node_get_contact_points-request>)))
  ...
  "comm_webots/node_get_contact_pointsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_get_contact_points-request)))
  "Returns string type for a service object of type 'node_get_contact_points-request"
  "comm_webots/node_get_contact_pointsRequest")
...
(cl:defclass <node_get_contact_points-response> (roslisp-msg-protocol:ros-message)
  ((contact_points
    ...
    :type (cl:vector comm_webots-msg:ContactPoint)
   :initform (cl:make-array 0 :element-type 'comm_webots-msg:ContactPoint :initial-element (cl:make-instance 'comm_webots-msg:ContactPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <node_get_contact_points-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_contact_points-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_webots-srv:<node_get_contact_points-response> is deprecated: use comm_webots-srv:node_get_contact_points-response instead.")))
...
(cl:defmethod contact_points-val ((m <node_get_contact_points-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_webots-srv:contact_points-val is deprecated.  Use comm_webots-srv:contact_points instead.")
  (contact_points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <node_get_contact_points-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'contact_points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'comm_webots-msg:ContactPoint))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<node_get_contact_points-response>)))
  ...
  "comm_webots/node_get_contact_pointsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_get_contact_points-response)))
  "Returns string type for a service object of type 'node_get_contact_points-response"
  "comm_webots/node_get_contact_pointsResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<node_get_contact_points-response>)))
  ...
  (cl:format cl:nil "comm_webots/ContactPoint[] contact_points~%~%~%================================================================================~%MSG: comm_webots/ContactPoint~%geometry_msgs/Point point~%int32 node_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'node_get_contact_points-response)))
  "Returns full string definition for message of type 'node_get_contact_points-response"
  (cl:format cl:nil "comm_webots/ContactPoint[] contact_points~%~%~%================================================================================~%MSG: comm_webots/ContactPoint~%geometry_msgs/Point point~%int32 node_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_get_contact_points)))
  ...
  "comm_webots/node_get_contact_points")