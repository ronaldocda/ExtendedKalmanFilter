...
(cl:defmethod cl:initialize-instance :after ((m <get_urdf-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_urdf-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_webots-srv:<get_urdf-request> is deprecated: use comm_webots-srv:get_urdf-request instead.")))

(cl:ensure-generic-function 'prefix-val :lambda-list '(m))
(cl:defmethod prefix-val ((m <get_urdf-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_webots-srv:prefix-val is deprecated.  Use comm_webots-srv:prefix instead.")
  (prefix m))
...
(cl:defmethod cl:initialize-instance :after ((m <get_urdf-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_urdf-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_webots-srv:<get_urdf-response> is deprecated: use comm_webots-srv:get_urdf-response instead.")))
