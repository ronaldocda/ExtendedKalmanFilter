...
(cl:defmethod cl:initialize-instance :after ((m <node_get_type-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_type-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<node_get_type-request> is deprecated: use tcc_msg-srv:node_get_type-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <node_get_type-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_type-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<node_get_type-response> is deprecated: use tcc_msg-srv:node_get_type-response instead.")))
