...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<lidar_get_info-request> is deprecated: use tcc_msg-srv:lidar_get_info-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<lidar_get_info-response> is deprecated: use tcc_msg-srv:lidar_get_info-response instead.")))
...
(cl:defmethod horizontalResolution-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:horizontalResolution-val is deprecated.  Use tcc_msg-srv:horizontalResolution instead.")
...
(cl:defmethod numberOfLayers-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:numberOfLayers-val is deprecated.  Use tcc_msg-srv:numberOfLayers instead.")
  (numberOfLayers m))

(cl:ensure-generic-function 'fov-val :lambda-list '(m))
(cl:defmethod fov-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:fov-val is deprecated.  Use tcc_msg-srv:fov instead.")
  (fov m))

(cl:ensure-generic-function 'verticalFov-val :lambda-list '(m))
(cl:defmethod verticalFov-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:verticalFov-val is deprecated.  Use tcc_msg-srv:verticalFov instead.")
  (verticalFov m))

(cl:ensure-generic-function 'minRange-val :lambda-list '(m))
(cl:defmethod minRange-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:minRange-val is deprecated.  Use tcc_msg-srv:minRange instead.")
  (minRange m))

(cl:ensure-generic-function 'maxRange-val :lambda-list '(m))
(cl:defmethod maxRange-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:maxRange-val is deprecated.  Use tcc_msg-srv:maxRange instead.")
  (maxRange m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lidar_get_info-response>)))
  ...
  "tcc_msg/lidar_get_infoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_info-response)))
  "Returns string type for a service object of type 'lidar_get_info-response"
  "tcc_msg/lidar_get_infoResponse")
