...
(cl:defmethod cl:initialize-instance :after ((m <speaker_speak-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'speaker_speak-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<speaker_speak-request> is deprecated: use tcc_msg-srv:speaker_speak-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <speaker_speak-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'speaker_speak-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<speaker_speak-response> is deprecated: use tcc_msg-srv:speaker_speak-response instead.")))
