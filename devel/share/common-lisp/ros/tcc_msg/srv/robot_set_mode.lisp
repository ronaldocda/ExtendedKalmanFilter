...
(cl:defmethod cl:initialize-instance :after ((m <robot_set_mode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_set_mode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<robot_set_mode-request> is deprecated: use tcc_msg-srv:robot_set_mode-request instead.")))

(cl:ensure-generic-function 'arg-val :lambda-list '(m))
(cl:defmethod arg-val ((m <robot_set_mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:arg-val is deprecated.  Use tcc_msg-srv:arg instead.")
  (arg m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <robot_set_mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:mode-val is deprecated.  Use tcc_msg-srv:mode instead.")
  (mode m))
...
(cl:defmethod cl:initialize-instance :after ((m <robot_set_mode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_set_mode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<robot_set_mode-response> is deprecated: use tcc_msg-srv:robot_set_mode-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_set_mode-response>)))
  ...
  "tcc_msg/robot_set_modeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_set_mode-response)))
  "Returns string type for a service object of type 'robot_set_mode-response"
  "tcc_msg/robot_set_modeResponse")
