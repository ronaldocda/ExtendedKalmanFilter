...
(cl:defmethod cl:initialize-instance :after ((m <WalkCreatorRequestSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WalkCreatorRequestSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<WalkCreatorRequestSrv-request> is deprecated: use tcc_msg-srv:WalkCreatorRequestSrv-request instead.")))

(cl:ensure-generic-function 'enabledGain-val :lambda-list '(m))
(cl:defmethod enabledGain-val ((m <WalkCreatorRequestSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:enabledGain-val is deprecated.  Use tcc_msg-srv:enabledGain instead.")
  (enabledGain m))

(cl:ensure-generic-function 'stepGain-val :lambda-list '(m))
(cl:defmethod stepGain-val ((m <WalkCreatorRequestSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:stepGain-val is deprecated.  Use tcc_msg-srv:stepGain instead.")
  (stepGain m))

(cl:ensure-generic-function 'lateralGain-val :lambda-list '(m))
(cl:defmethod lateralGain-val ((m <WalkCreatorRequestSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:lateralGain-val is deprecated.  Use tcc_msg-srv:lateralGain instead.")
  (lateralGain m))

(cl:ensure-generic-function 'turnGain-val :lambda-list '(m))
(cl:defmethod turnGain-val ((m <WalkCreatorRequestSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-srv:turnGain-val is deprecated.  Use tcc_msg-srv:turnGain instead.")
  (turnGain m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WalkCreatorRequestSrv-request>)))
  ...
  "tcc_msg/WalkCreatorRequestSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WalkCreatorRequestSrv-request)))
  "Returns string type for a service object of type 'WalkCreatorRequestSrv-request"
  "tcc_msg/WalkCreatorRequestSrvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <WalkCreatorRequestSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WalkCreatorRequestSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<WalkCreatorRequestSrv-response> is deprecated: use tcc_msg-srv:WalkCreatorRequestSrv-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WalkCreatorRequestSrv-response>)))
  ...
  "tcc_msg/WalkCreatorRequestSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WalkCreatorRequestSrv-response)))
  "Returns string type for a service object of type 'WalkCreatorRequestSrv-response"
  "tcc_msg/WalkCreatorRequestSrvResponse")
