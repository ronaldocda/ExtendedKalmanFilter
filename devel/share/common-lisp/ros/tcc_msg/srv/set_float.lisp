...
(cl:defmethod cl:initialize-instance :after ((m <set_float-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_float-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<set_float-request> is deprecated: use tcc_msg-srv:set_float-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <set_float-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_float-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<set_float-response> is deprecated: use tcc_msg-srv:set_float-response instead.")))
