...
(cl:defmethod cl:initialize-instance :after ((m <node_remove-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_remove-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<node_remove-request> is deprecated: use tcc_msg-srv:node_remove-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <node_remove-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_remove-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<node_remove-response> is deprecated: use tcc_msg-srv:node_remove-response instead.")))
