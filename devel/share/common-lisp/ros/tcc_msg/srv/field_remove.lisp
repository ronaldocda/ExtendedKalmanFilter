...
(cl:defmethod cl:initialize-instance :after ((m <field_remove-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_remove-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<field_remove-request> is deprecated: use tcc_msg-srv:field_remove-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_remove-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_remove-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<field_remove-response> is deprecated: use tcc_msg-srv:field_remove-response instead.")))
