...
(cl:defmethod cl:initialize-instance :after ((m <save_image-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'save_image-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<save_image-request> is deprecated: use tcc_msg-srv:save_image-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <save_image-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'save_image-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<save_image-response> is deprecated: use tcc_msg-srv:save_image-response instead.")))
