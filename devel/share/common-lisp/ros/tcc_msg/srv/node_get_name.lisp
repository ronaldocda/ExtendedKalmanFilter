...
(cl:defmethod cl:initialize-instance :after ((m <node_get_name-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_name-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<node_get_name-request> is deprecated: use tcc_msg-srv:node_get_name-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <node_get_name-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_name-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<node_get_name-response> is deprecated: use tcc_msg-srv:node_get_name-response instead.")))
