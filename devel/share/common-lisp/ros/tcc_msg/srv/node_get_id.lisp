...
(cl:defmethod cl:initialize-instance :after ((m <node_get_id-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_id-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<node_get_id-request> is deprecated: use tcc_msg-srv:node_get_id-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <node_get_id-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_id-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<node_get_id-response> is deprecated: use tcc_msg-srv:node_get_id-response instead.")))
