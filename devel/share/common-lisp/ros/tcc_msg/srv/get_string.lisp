...
(cl:defmethod cl:initialize-instance :after ((m <get_string-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_string-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<get_string-request> is deprecated: use tcc_msg-srv:get_string-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <get_string-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_string-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-srv:<get_string-response> is deprecated: use tcc_msg-srv:get_string-response instead.")))
