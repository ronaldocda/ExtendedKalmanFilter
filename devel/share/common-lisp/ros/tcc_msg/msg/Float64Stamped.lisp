...
(cl:defmethod cl:initialize-instance :after ((m <Float64Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcc_msg-msg:<Float64Stamped> is deprecated: use tcc_msg-msg:Float64Stamped instead.")))
...
(cl:defmethod data-val ((m <Float64Stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcc_msg-msg:data-val is deprecated.  Use tcc_msg-msg:data instead.")
  (data m))
