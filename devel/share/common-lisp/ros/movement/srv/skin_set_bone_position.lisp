...
(cl:defmethod cl:initialize-instance :after ((m <skin_set_bone_position-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'skin_set_bone_position-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<skin_set_bone_position-request> is deprecated: use movement-srv:skin_set_bone_position-request instead.")))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <skin_set_bone_position-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-srv:index-val is deprecated.  Use movement-srv:index instead.")
  (index m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <skin_set_bone_position-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-srv:position-val is deprecated.  Use movement-srv:position instead.")
  (position m))

(cl:ensure-generic-function 'absolute-val :lambda-list '(m))
(cl:defmethod absolute-val ((m <skin_set_bone_position-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-srv:absolute-val is deprecated.  Use movement-srv:absolute instead.")
  (absolute m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<skin_set_bone_position-request>)))
  ...
  "movement/skin_set_bone_positionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'skin_set_bone_position-request)))
  "Returns string type for a service object of type 'skin_set_bone_position-request"
  "movement/skin_set_bone_positionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <skin_set_bone_position-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'skin_set_bone_position-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<skin_set_bone_position-response> is deprecated: use movement-srv:skin_set_bone_position-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<skin_set_bone_position-response>)))
  ...
  "movement/skin_set_bone_positionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'skin_set_bone_position-response)))
  "Returns string type for a service object of type 'skin_set_bone_position-response"
  "movement/skin_set_bone_positionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'skin_set_bone_position)))
  ...
  "movement/skin_set_bone_position")