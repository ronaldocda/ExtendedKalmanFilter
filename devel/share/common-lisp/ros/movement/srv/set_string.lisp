...
(cl:defmethod cl:initialize-instance :after ((m <set_string-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_string-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<set_string-request> is deprecated: use movement-srv:set_string-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <set_string-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_string-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<set_string-response> is deprecated: use movement-srv:set_string-response instead.")))
