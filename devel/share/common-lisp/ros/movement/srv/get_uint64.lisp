...
(cl:defmethod cl:initialize-instance :after ((m <get_uint64-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_uint64-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<get_uint64-request> is deprecated: use movement-srv:get_uint64-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <get_uint64-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_uint64-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<get_uint64-response> is deprecated: use movement-srv:get_uint64-response instead.")))
