...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_frequency_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_frequency_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<lidar_get_frequency_info-request> is deprecated: use movement-srv:lidar_get_frequency_info-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lidar_get_frequency_info-request>)))
  ...
  "movement/lidar_get_frequency_infoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_frequency_info-request)))
  "Returns string type for a service object of type 'lidar_get_frequency_info-request"
  "movement/lidar_get_frequency_infoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_frequency_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_frequency_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<lidar_get_frequency_info-response> is deprecated: use movement-srv:lidar_get_frequency_info-response instead.")))

(cl:ensure-generic-function 'frequency-val :lambda-list '(m))
(cl:defmethod frequency-val ((m <lidar_get_frequency_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-srv:frequency-val is deprecated.  Use movement-srv:frequency instead.")
  (frequency m))
...
(cl:defmethod minFrequency-val ((m <lidar_get_frequency_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-srv:minFrequency-val is deprecated.  Use movement-srv:minFrequency instead.")
  (minFrequency m))
...
(cl:defmethod maxFrequency-val ((m <lidar_get_frequency_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-srv:maxFrequency-val is deprecated.  Use movement-srv:maxFrequency instead.")
  (maxFrequency m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lidar_get_frequency_info-response>)))
  ...
  "movement/lidar_get_frequency_infoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_frequency_info-response)))
  "Returns string type for a service object of type 'lidar_get_frequency_info-response"
  "movement/lidar_get_frequency_infoResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_frequency_info)))
  ...
  "movement/lidar_get_frequency_info")