...
(cl:defmethod cl:initialize-instance :after ((m <display_image_new-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_image_new-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<display_image_new-request> is deprecated: use movement-srv:display_image_new-request instead.")))
...
(cl:defmethod data-val ((m <display_image_new-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-srv:data-val is deprecated.  Use movement-srv:data instead.")
  (data m))

(cl:ensure-generic-function 'format-val :lambda-list '(m))
(cl:defmethod format-val ((m <display_image_new-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-srv:format-val is deprecated.  Use movement-srv:format instead.")
  (format m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<display_image_new-request>)))
  ...
  "movement/display_image_newRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'display_image_new-request)))
  "Returns string type for a service object of type 'display_image_new-request"
  "movement/display_image_newRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <display_image_new-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_image_new-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-srv:<display_image_new-response> is deprecated: use movement-srv:display_image_new-response instead.")))

(cl:ensure-generic-function 'ir-val :lambda-list '(m))
(cl:defmethod ir-val ((m <display_image_new-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-srv:ir-val is deprecated.  Use movement-srv:ir instead.")
  (ir m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<display_image_new-response>)))
  ...
  "movement/display_image_newResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'display_image_new-response)))
  "Returns string type for a service object of type 'display_image_new-response"
  "movement/display_image_newResponse")
