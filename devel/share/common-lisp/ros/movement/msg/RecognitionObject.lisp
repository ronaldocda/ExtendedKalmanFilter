...
(cl:defmethod cl:initialize-instance :after ((m <RecognitionObject>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RecognitionObject)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-msg:<RecognitionObject> is deprecated: use movement-msg:RecognitionObject instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <RecognitionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:position-val is deprecated.  Use movement-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <RecognitionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:orientation-val is deprecated.  Use movement-msg:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'position_on_image-val :lambda-list '(m))
(cl:defmethod position_on_image-val ((m <RecognitionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:position_on_image-val is deprecated.  Use movement-msg:position_on_image instead.")
  (position_on_image m))

(cl:ensure-generic-function 'size_on_image-val :lambda-list '(m))
(cl:defmethod size_on_image-val ((m <RecognitionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:size_on_image-val is deprecated.  Use movement-msg:size_on_image instead.")
  (size_on_image m))

(cl:ensure-generic-function 'number_of_colors-val :lambda-list '(m))
(cl:defmethod number_of_colors-val ((m <RecognitionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:number_of_colors-val is deprecated.  Use movement-msg:number_of_colors instead.")
  (number_of_colors m))

(cl:ensure-generic-function 'colors-val :lambda-list '(m))
(cl:defmethod colors-val ((m <RecognitionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:colors-val is deprecated.  Use movement-msg:colors instead.")
  (colors m))

(cl:ensure-generic-function 'model-val :lambda-list '(m))
(cl:defmethod model-val ((m <RecognitionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:model-val is deprecated.  Use movement-msg:model instead.")
  (model m))
