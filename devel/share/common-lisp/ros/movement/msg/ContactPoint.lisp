...
(cl:defmethod cl:initialize-instance :after ((m <ContactPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ContactPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-msg:<ContactPoint> is deprecated: use movement-msg:ContactPoint instead.")))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <ContactPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:point-val is deprecated.  Use movement-msg:point instead.")
  (point m))

(cl:ensure-generic-function 'node_id-val :lambda-list '(m))
(cl:defmethod node_id-val ((m <ContactPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:node_id-val is deprecated.  Use movement-msg:node_id instead.")
  (node_id m))
