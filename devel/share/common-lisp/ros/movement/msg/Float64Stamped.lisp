...
(cl:defmethod cl:initialize-instance :after ((m <Float64Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movement-msg:<Float64Stamped> is deprecated: use movement-msg:Float64Stamped instead.")))
...
(cl:defmethod data-val ((m <Float64Stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement-msg:data-val is deprecated.  Use movement-msg:data instead.")
  (data m))
