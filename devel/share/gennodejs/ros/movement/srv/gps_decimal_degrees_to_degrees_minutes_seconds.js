...
class gps_decimal_degrees_to_degrees_minutes_secondsRequest {
  ...
  static datatype() {
    ...
    return 'movement/gps_decimal_degrees_to_degrees_minutes_secondsRequest';
  }
...
class gps_decimal_degrees_to_degrees_minutes_secondsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'movement/gps_decimal_degrees_to_degrees_minutes_secondsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'movement/gps_decimal_degrees_to_degrees_minutes_seconds'; }
};
