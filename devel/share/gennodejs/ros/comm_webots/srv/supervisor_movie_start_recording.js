...
class supervisor_movie_start_recordingRequest {
  ...
  static datatype() {
    ...
    return 'comm_webots/supervisor_movie_start_recordingRequest';
  }
...
class supervisor_movie_start_recordingResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'comm_webots/supervisor_movie_start_recordingResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'comm_webots/supervisor_movie_start_recording'; }
};
