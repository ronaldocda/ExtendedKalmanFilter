...
class node_get_contact_pointsRequest {
  ...
  static datatype() {
    ...
    return 'comm_webots/node_get_contact_pointsRequest';
  }
...
class node_get_contact_pointsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'comm_webots/node_get_contact_pointsResponse';
  }
  ...
  static messageDefinition() {
    // Returns full string definition for message
    return `
    comm_webots/ContactPoint[] contact_points
    
    
    ================================================================================
    MSG: comm_webots/ContactPoint
...
module.exports = {
  ...
  datatype() { return 'comm_webots/node_get_contact_points'; }
};
