...
class node_add_force_or_torqueRequest {
  ...
  static datatype() {
    ...
    return 'comm_webots/node_add_force_or_torqueRequest';
  }
...
class node_add_force_or_torqueResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'comm_webots/node_add_force_or_torqueResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'comm_webots/node_add_force_or_torque'; }
};
