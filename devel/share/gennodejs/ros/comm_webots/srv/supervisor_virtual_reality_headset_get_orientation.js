...
class supervisor_virtual_reality_headset_get_orientationRequest {
  ...
  static datatype() {
    ...
    return 'comm_webots/supervisor_virtual_reality_headset_get_orientationRequest';
  }
...
class supervisor_virtual_reality_headset_get_orientationResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'comm_webots/supervisor_virtual_reality_headset_get_orientationResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'comm_webots/supervisor_virtual_reality_headset_get_orientation'; }
};
