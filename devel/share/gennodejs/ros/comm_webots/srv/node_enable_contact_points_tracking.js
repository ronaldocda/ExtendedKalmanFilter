...
class node_enable_contact_points_trackingRequest {
  ...
  static datatype() {
    ...
    return 'comm_webots/node_enable_contact_points_trackingRequest';
  }
...
class node_enable_contact_points_trackingResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'comm_webots/node_enable_contact_points_trackingResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'comm_webots/node_enable_contact_points_tracking'; }
};
