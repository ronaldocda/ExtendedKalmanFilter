...
class node_enable_pose_trackingRequest {
  ...
  static datatype() {
    ...
    return 'comm_webots/node_enable_pose_trackingRequest';
  }
...
class node_enable_pose_trackingResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'comm_webots/node_enable_pose_trackingResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'comm_webots/node_enable_pose_tracking'; }
};
