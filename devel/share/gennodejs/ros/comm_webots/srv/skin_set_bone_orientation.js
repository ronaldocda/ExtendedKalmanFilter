...
class skin_set_bone_orientationRequest {
  ...
  static datatype() {
    ...
    return 'comm_webots/skin_set_bone_orientationRequest';
  }
...
class skin_set_bone_orientationResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'comm_webots/skin_set_bone_orientationResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'comm_webots/skin_set_bone_orientation'; }
};
