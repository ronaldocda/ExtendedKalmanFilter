...
class node_get_number_of_fieldsRequest {
  ...
  static datatype() {
    ...
    return 'comm_webots/node_get_number_of_fieldsRequest';
  }
...
class node_get_number_of_fieldsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'comm_webots/node_get_number_of_fieldsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'comm_webots/node_get_number_of_fields'; }
};
